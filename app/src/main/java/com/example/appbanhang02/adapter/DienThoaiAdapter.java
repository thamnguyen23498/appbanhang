...
public class DienThoaiAdapter extends RecyclerView.Adapter<DienThoaiAdapter.ViewHolder> {
    ...
    public DienThoaiAdapter(ArrayList<Sanpham> arrSp, Context context, OnItemClickListener listener) {
        this.arrSp = arrSp;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ImageView img_sp;
        TextView txt_tendienthoai,txt_gia,txt_mottadienthoai;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            txt_mottadienthoai = (TextView)itemView.findViewById(R.id.txt_mottadienthoai);
            txt_tendienthoai = (TextView)itemView.findViewById(R.id.txt_tendienthoai);
        }
        @RequiresApi(api = Build.VERSION_CODES.N)
        public void BindData(Sanpham sanpham){
            this.sanpham = sanpham;
            txt_tendienthoai.setText(sanpham.getTensp());
            DecimalFormat decimalFormat = new DecimalFormat("###,###,###");
            txt_gia.setText("Giá : " + decimalFormat.format(sanpham.getGiasp() )+ " Đ");
            txt_mottadienthoai.setText(sanpham.getMotasp());
